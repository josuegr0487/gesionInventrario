		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="post" id="editar_unidad" name="editar_unidad">
					...
					<div class="form-group">
						<label for="mod_abreviatura" class="col-sm-3 control-label">Abreviatura</label>
						<div class="col-sm-8">
							<input type="text" style="text-transform: uppercase;" class="form-control" id="mod_abreviatura" name="mod_abreviatura" required>
						</div>
					</div>
