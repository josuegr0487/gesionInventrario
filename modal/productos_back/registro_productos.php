				...
				<div class="modal-body">
					<form class="form-horizontal" enctype="multipart/form-data" method="post" id="guardar_producto" name="guardar_producto">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" id="marca" name="marca" placeholder="Marca del producto">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" id="modelo" name="modelo" placeholder="Modelo del producto">
							</div>
						</div>
