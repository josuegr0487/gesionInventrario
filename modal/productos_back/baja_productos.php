        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Baja producto</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" id="bajar_producto" name="bajar_producto">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="mod_stock" name="mod_stock" placeholder="Stock del producto" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='mod_ubicacion' id='mod_ubicacion' disabled>
                                    <option value="">Selecciona una ubicación</option>
                                    <?php
                                    $query_ubicacion = mysqli_query($con, "select * from ubicaciones order by nombre_ubicacion");
                                    while ($rw = mysqli_fetch_array($query_ubicacion)) {
                                    ?>
                                        <option value="<?php echo $rw['id_ubicacion']; ?>"><?php echo $rw['nombre_ubicacion']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="mod_marca" name="mod_marca" placeholder="Marca del producto" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="mod_modelo" name="mod_modelo" placeholder="Modelo del producto" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="mod_proyecto" class="col-sm-3 control-label">Proyecto</label>
                            <div class="col-sm-8">
                                <select class='form-control' name='mod_proyecto' id='mod_proyecto' disabled>
                        ...
                        <div class="form-group">
                            <label for="mod_propietario" class="col-sm-3 control-label">Propietario</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_propietario" name="mod_propietario" placeholder="Propietario" readonly>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="mod_motivo" class="col-sm-3 control-label">Motivo de Baja</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_motivo" name="mod_motivo" placeholder="Motivo de Baja" required>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="actualizar_datos">Dar de Baja</button>
                </div>
                </form>
            </div>
        </div>
