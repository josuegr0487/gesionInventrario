				...
				<div class="modal-body">
					<form class="form-horizontal" enctype="multipart/form-data" method="post" id="editar_producto" name="editar_producto">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" id="mod_stock" name="mod_stock" placeholder="Stock del producto" value="0">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="mod_marca" name="mod_marca" placeholder="Marca del producto">
							</div>
						</div>
