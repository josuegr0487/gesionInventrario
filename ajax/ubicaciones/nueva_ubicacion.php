...
if (empty($_POST['nombre'])) {
	...
	$sql = "INSERT INTO ubicaciones (nombre_ubicacion, date_added) VALUES ('$nombre', '$date_added')";
	$query_new_insert = mysqli_query($con, $sql); //se crea nueva ubicacion
	if ($query_new_insert) { //si la ubicacion se creo exitosamente
		$messages[] = "Ubicacion ha sido ingresada satisfactoriamente.";
	} else {
