...
if (empty($_POST['mod_id'])) {
	...
	$id_ubicacion = intval($_POST['mod_id']);
	$sql = "UPDATE ubicaciones SET nombre_ubicacion='" . $nombre . "' WHERE id_ubicacion='" . $id_ubicacion . "'";
	$query_update = mysqli_query($con, $sql); //se actualiza ubicacion
	if ($query_update) { //si la ubicacion se actualizo exitosamente
		$messages[] = "Ubicación ha sido actualizada satisfactoriamente.";
	} else {
