...
if (empty($_POST['mod_codigo'])) {
	...
	if ($nombre_img == !NULL) {
		...
		$sql = "UPDATE productos SET descripcion_producto = '" . $nombre . "', url_image = '" . $nombre_img . "', stock = '" . $stock . "', id_unidad = '" . $id_unidad . "', marca = '" . $marca . "', modelo = '" . $modelo . "', numero_serie = '" . $numserie . "', observaciones = '" . $observaciones . "' WHERE id_producto='" . $id_producto . "'";
	...
	if (empty($errors)) {
		if (empty($sql)){
			$sql = "UPDATE productos SET descripcion_producto = '" . $nombre . "', stock = '" . $stock . "',  id_unidad = '" . $id_unidad . "', marca = '" . $marca . "', modelo = '" . $modelo . "', numero_serie = '" . $numserie . "', observaciones = '" . $observaciones . "'  WHERE id_producto='" . $id_producto . "'";
		}
